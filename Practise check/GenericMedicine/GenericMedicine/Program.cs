    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Please enter the expiry date for the medicine in dd/mm/yyyy format.");
                ...
                if (response.ToLower().Equals("y"))
                {
                    ...
                    Console.WriteLine("Please enter the date for which you want to send to retailer in dd/mm/yyyy format. Please check that the launch date should be lesser than the expiry date");
